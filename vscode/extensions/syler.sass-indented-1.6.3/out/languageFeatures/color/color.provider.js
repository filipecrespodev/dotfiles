...
class SassColorProvider {
    ...
    provideDocumentColors(document, token) {
        ...
        for (let i = 0; i < document.lineCount; i++) {
            ...
            if (utility_regex_1.hasColor(line.text)) {
                ...
                for (let j = 0; j < colorsPositions.length; j++) {
                    ...
                    colors.push(new vscode_1.ColorInformation(new vscode_1.Range(new vscode_1.Position(line.range.start.line, colorPos.start), new vscode_1.Position(line.range.start.line, colorPos.end)), color_utils_1.ColorUtilities.convertStringToColor(colorPos.text)));
                }
            }
        }
        return colors;
