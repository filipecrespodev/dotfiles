...
const autocomplete_data_dataProps_1 = require("./schemas/generatedData/autocomplete.data.dataProps");
...
class AutocompleteUtilities {
    ...
    static isValue(cssSchema, currentWord) {
        ...
        if (vscode_1.workspace.getConfiguration('sass').get('autocomplete.useExperimentalData') === true) {
            return property && !!autocomplete_data_dataProps_1.dataProps[property];
        }
    ...
    static findPropertySchema(cssSchema, property) {
        if (vscode_1.workspace.getConfiguration('sass').get('autocomplete.useExperimentalData') === true) {
            return autocomplete_data_dataProps_1.dataProps[property];
        }
