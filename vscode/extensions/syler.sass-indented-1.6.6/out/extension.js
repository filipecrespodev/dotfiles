...
function activate(context) {
    ...
    const SassFormatterRegister = vscode.languages.registerDocumentFormattingEditProvider([{ language: 'sass', scheme: 'file' }, { language: 'sass', scheme: 'untitled' }], SassFormatter);
    // Events
    ...
    const hoverDisposable = vscode.languages.registerHoverProvider([{ language: 'sass', scheme: 'file' }, { language: 'sass', scheme: 'untitled' }], {
        provideHover: hover.provideHover
    });
    const color = new color_provider_1.SassColorProvider();
    const colorDisposable = vscode.languages.registerColorProvider([{ language: 'sass', scheme: 'file' }, { language: 'sass', scheme: 'untitled' }], {
