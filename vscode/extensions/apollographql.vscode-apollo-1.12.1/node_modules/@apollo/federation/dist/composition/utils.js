...
function isExecutableDirective(directive) {
    return directive.locations.every(location => exports.executableDirectiveLocations.includes(location));
}
exports.isExecutableDirective = isExecutableDirective;
