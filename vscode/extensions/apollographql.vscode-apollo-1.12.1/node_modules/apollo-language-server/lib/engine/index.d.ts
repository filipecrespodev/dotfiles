...
import { ListServicesVariables, CheckSchemaVariables, UploadSchemaVariables, UploadAndComposePartialSchemaVariables, RegisterOperationsVariables, ValidateOperationsVariables, CheckPartialSchemaVariables, RemoveServiceAndComposeVariables, CheckPartialSchema_service_checkPartialSchema } from "../graphqlTypes";
...
export declare class ApolloEngineClient extends GraphQLDataSource {
    ...
    listServices(variables: ListServicesVariables): Promise<import("../graphqlTypes").ListServices_service>;
