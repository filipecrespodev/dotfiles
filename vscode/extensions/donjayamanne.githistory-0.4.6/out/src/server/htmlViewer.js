...
let HtmlViewer = class HtmlViewer {
    constructor(serviceContainer) {
        ...
        this.onPreviewHtml = (uri, column, title) => {
            return this.getHtmlView(vscode_1.Uri.parse(uri), column, title);
        };
    ...
    getHtmlView(uri, column, title) {
        ...
        const webviewPanel = vscode_2.window.createWebviewPanel('gitLog', title, column, { enableScripts: true, retainContextWhenHidden: true });
