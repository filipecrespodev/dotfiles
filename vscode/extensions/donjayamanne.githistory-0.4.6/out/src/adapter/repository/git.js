...
let Git = class Git {
    ...
    getGitRoots(rootDirectory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitFoldersList = yield Promise.all(rootDirectories.map(item => this.getGitReposInFolder(item)));
    ...
    getOriginType() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.exec('remote', 'get-url', remoteName)
                    .then(url => {
    ...
    getGitReposInFolder(dir) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(resolve => {
                fs.readdir(dir, (err, filesAndFolders) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                        return resolve([]);
                    }
                    ...
                    const folders = yield helpers_1.asyncFilter(filteredItems, (item) => __awaiter(this, void 0, void 0, function* () { return (yield fs.stat(item)).isDirectory(); }));
                    const gitRootArgs = this.gitArgsService.getGitRootArgs();
                    const gitRoots = (yield Promise.all(folders.map((item) => __awaiter(this, void 0, void 0, function* () {
                        try {
                            const result = yield this.gitCmdExecutor.exec(item, ...gitRootArgs);
